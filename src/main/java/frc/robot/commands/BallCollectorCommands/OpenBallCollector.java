...
public class OpenBallCollector extends Command {
  ...
  public void initialize() {
    mBallCollector.setArmReference(BallCollectorConstants.OPEN_POSITION);
    SmartDashboard.putBoolean("BALLCOLLECTOR", true);
  }
  ...
  public void end(boolean interrupted) {
    ...
    SmartDashboard.putBoolean("BALLCOLLECTOR", false);
  }

  // Returns true when the command should end.
  @Override
  public boolean isFinished() {
    return mBallCollector.atPosition(BallCollectorConstants.OPEN_POSITION);
  }
}
